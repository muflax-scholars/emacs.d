...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; Rainbow Delimiters
   `(rainbow-delimiters-depth-1-face ((,class (:bold t :foreground "#cc0000"))))
   `(rainbow-delimiters-depth-2-face ((,class (:bold t :foreground "#1f5bff"))))
   `(rainbow-delimiters-depth-3-face ((,class (:bold t :foreground "#00af00"))))
