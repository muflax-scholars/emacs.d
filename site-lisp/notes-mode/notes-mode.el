...
;;; Commentary:
;;
;; This mode implements the notation I use to write notes (and teaching scripts). It helps you write any documentation in the most desirable style, that of prompted examples.
;;
;; It adds annotations to normal plain text. It works like this:
;;
...
;; $ (Yes, you are.)
;;
;; $ Lines that start with a special character are annotation lines. Watch this:
;;
;; % How do you start a quote?
;; @ With a >.
;;
;; $ As you can see, a % begins a prompt, whereas @ marks the expected reply or answer. They are typically used as a pair.
;;
;; $ A @ by itself denotes an example. The remaining notations are:
;;
;; $ the abstract concept the following section is supposed to present:
;; @ + remaining line annotations
;;
;; $ a comment on the text:
;; @ # we will use notation only after we've explained it
;;
;; $ wrong or otherwise invalid examples:
;; @ ! 2 + 3 = 7
;;
...
;; @ = 4 = 2 + 2
;;
;; All line annotations are, of course, optional. The rest of the document will use them were appropriate.
;;
;; + highlighting
;;
;; emphasis:
