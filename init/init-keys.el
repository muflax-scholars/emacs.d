...
(key-def global-map "C-x"	'command-prefix-map 'prefix)
...
(key-def command-prefix-map "C-+"	'text-scale-adjust)
(key-def command-prefix-map "C--"	'text-scale-adjust)
(key-def command-prefix-map "C-="	'text-scale-adjust)
(key-def command-prefix-map "C-0"	'text-scale-adjust)
(key-def command-prefix-map "C-b"	'list-buffers)
(key-def command-prefix-map "C-c"	'save-buffers-kill-terminal)
(key-def command-prefix-map "C-f"	'find-file)
(key-def command-prefix-map "C-g"	'abort-recursive-edit)
(key-def command-prefix-map "C-r"	'recentf-ido-find-file)
(key-def command-prefix-map "C-s"	'save-buffer)
(key-def command-prefix-map "C-v"	'find-alternate-file)
(key-def command-prefix-map "C-w"	'write-file)
(key-def command-prefix-map "C-x"	'exchange-point-and-mark)
(key-def command-prefix-map "M-f"	'find-file-at-point)
(key-def command-prefix-map "SPC"	'eval-prefix-map 'prefix)
(key-def command-prefix-map "#"  	'server-edit)
(key-def command-prefix-map "("  	'sexp-prefix-map 'prefix)
(key-def command-prefix-map "+"  	'balance-windows)
(key-def command-prefix-map "a"  	'align-prefix-map 'prefix)
(key-def command-prefix-map "b"  	'switch-to-buffer)
(key-def command-prefix-map "c"  	'case-prefix-map 'prefix)
(key-def command-prefix-map "d"  	'debug-prefix-map 'prefix)
(key-def command-prefix-map "f"  	'font-prefix-map 'prefix)
(key-def command-prefix-map "g"  	'magit-status)
(key-def command-prefix-map "h"  	'mark-whole-buffer)
(key-def command-prefix-map "i"  	'indent-region)
(key-def command-prefix-map "k"  	'kill-buffer)
(key-def command-prefix-map "m"  	'number-prefix-map 'prefix)
(key-def command-prefix-map "M"  	'macro-prefix-map 'prefix)
(key-def command-prefix-map "n"  	'narrow-map)
(key-def command-prefix-map "p"  	'paradox-list-packages)
(key-def command-prefix-map "r"  	'rectangle-prefix-map 'prefix)
(key-def command-prefix-map "R"  	'register-prefix-map 'prefix)
(key-def command-prefix-map "s"  	'save-some-buffers)
(key-def command-prefix-map "t"  	'input-prefix-map 'prefix)
(key-def command-prefix-map "w"  	'spell-check-prefix-map 'prefix)
(key-def command-prefix-map "x"  	'helm-prefix-map 'prefix)
(key-def command-prefix-map "z"  	'repeat)
(key-def command-prefix-map "Z"  	'repeat-complex-command)
...
(key-def search-prefix-map "e"  	'next-error)
(key-def search-prefix-map "E"  	'previous-error)
...
(setup-after "lisp-mode"
  ;; operate on sexps
  ;; (key-def lisp-mode-map "C-<return>"	'md/duplicate-down)
...
;; fonts
(key-def font-prefix-map "<f1>"	'use-small-font)
(key-def font-prefix-map "<f2>"	'use-normal-font)
(key-def font-prefix-map "<f3>"	'use-big-font)
(key-def font-prefix-map "<f4>"	'use-huge-font)
