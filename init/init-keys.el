...
(key-def global-map "C-x"	'commands-prefix-map 'prefix)
...
(key-def commands-prefix-map "C-+"	'text-scale-adjust)
(key-def commands-prefix-map "C--"	'text-scale-adjust)
(key-def commands-prefix-map "C-="	'text-scale-adjust)
(key-def commands-prefix-map "C-0"	'text-scale-adjust)
(key-def commands-prefix-map "C-b"	'list-buffers)
(key-def commands-prefix-map "C-c"	'save-buffers-kill-terminal)
(key-def commands-prefix-map "C-f"	'find-file)
(key-def commands-prefix-map "C-r"	'recentf-ido-find-file)
(key-def commands-prefix-map "C-s"	'save-buffer)
(key-def commands-prefix-map "C-v"	'find-alternate-file)
(key-def commands-prefix-map "C-w"	'write-file)
(key-def commands-prefix-map "C-x"	'exchange-point-and-mark)
(key-def commands-prefix-map "M-f"	'find-file-at-point)
(key-def commands-prefix-map "SPC"	'eval-prefix-map 'prefix)
(key-def commands-prefix-map "#"  	'server-edit)
(key-def commands-prefix-map "+"  	'balance-windows)
(key-def commands-prefix-map "a"  	'align-prefix-map 'prefix)
(key-def commands-prefix-map "b"  	'switch-to-buffer)
(key-def commands-prefix-map "c"  	'case-prefix-map 'prefix)
(key-def commands-prefix-map "d"  	'debug-prefix-map 'prefix)
(key-def commands-prefix-map "g"  	'magit-status)
(key-def commands-prefix-map "h"  	'mark-whole-buffer)
(key-def commands-prefix-map "k"  	'kill-buffer)
(key-def commands-prefix-map "m"  	'macro-prefix-map 'prefix)
(key-def commands-prefix-map "n"  	'narrow-map)
(key-def commands-prefix-map "p"  	'paradox-list-packages)
(key-def commands-prefix-map "r"  	'rectangle-prefix-map 'prefix)
(key-def commands-prefix-map "R"  	'register-prefix-map 'prefix)
(key-def commands-prefix-map "s"  	'save-some-buffers)
(key-def commands-prefix-map "t"  	'input-prefix-map 'prefix)
(key-def commands-prefix-map "w"  	'spell-check-prefix-map 'prefix)
(key-def commands-prefix-map "x"  	'helm-prefix-map 'prefix)
(key-def commands-prefix-map "z"  	'repeat)
(key-def commands-prefix-map "Z"  	'repeat-complex-command)
